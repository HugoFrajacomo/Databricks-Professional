...
def batch_upsert(microBatchDF, batchId):
    window = Window.partitionBy("order_id", "customer_id").orderBy(F.col("_commit_timestamp").desc()) #utilizando chave composta
    
    (microBatchDF.filter(F.col("_change_type").isin(["insert", "update_postimage"])) #apenas insert e update
...
# MAGIC %md
# MAGIC ## Fazendo um join com duas streaming tables
